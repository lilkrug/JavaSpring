package by.kruglik.stp_lab1.controller;
import by.kruglik.stp_lab1.forms.BookForm;
import by.kruglik.stp_lab1.model.Book;
...
public class BookController
{
    ...
    static
    {
        books.add(new Book("What is people", "Mark Tven"));
        books.add(new Book("Joan Roaling", "Garry Potter"));
    }
